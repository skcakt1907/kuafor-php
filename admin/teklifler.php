...
if(isset($_GET['sil'])){
    ...
    adminFlash('Randevu talebi silindi.');
...
if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['id'])){
    ...
    adminFlash('Randevu güncellendi.');
...
<div class="card mb-4">
  ...
  <div class="card-body">
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-3"><small class="text-muted">Tarih & Saat</small><div><?= e($detay['il'])?:'—' ?></div></div>
      <div class="col-md-3"><small class="text-muted">Kişi Sayısı</small><div><?= e($detay['alan'])?:'—' ?></div></div>
...
<div class="card">
  ...
  <div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
      <thead><tr><th>#</th><th>Ad</th><th>Telefon</th><th>Hizmet</th><th>Tip</th><th>Durum</th><th>Tarih</th><th></th></tr></thead>
      <tbody>
