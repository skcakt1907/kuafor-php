...
<section class="page-head">
  <div class="container">
    <h1><?= e($h['baslik']) ?></h1>
    <nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/">Anasayfa</a></li><li class="breadcrumb-item"><a href="<?= SITE_URL ?>/hizmetler">Hizmetlerimiz</a></li><li class="breadcrumb-item active"><?= e($h['baslik']) ?></li></ol></nav>
  </div>
</section>
